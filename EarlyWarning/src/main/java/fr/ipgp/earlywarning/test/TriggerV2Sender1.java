...
public class TriggerV2Sender1 {
    ...
    public static void main(String[] args) {
        ...
        String messageString = "02 1 " + simpleFormat.format(date1) + " nagios 0692703856,0262248610 true 11 |Alerte, plus de place sur partage|";
